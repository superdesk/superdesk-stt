...
class STTEventDeskNetFormatter(Formatter):
    ...
    def format_concept(self, article, parentNode):
        ...
        SubElement(
            ...
            "conceptId",
            attrib={
                "qcode": "sttevents:" + article.get("guid", ""),
                "created": createdStr,
            },
        )
                ...
                if "scheme" in s and "name" in s:
                    if s["scheme"] == "event_type":
                        related = SubElement(
                            ...
                            "related",
                            attrib={
                                "rel": "sttnat:sttEventType",
                                "qcode": "sttEventType:" + s["qcode"],
                            },
                        )
    ...
    async def format(self, article, subscriber, codes=None):
        ...
        try:
            ...
            conceptItem = etree.Element(
                "conceptItem",
                attrib={
                    "guid": "urn:newsml:stt.fi:"
                    + dateStr
                    + ":"
                    + article.get("guid", ""),
