...
GOOGLE_CLOUD_TRANSLATE_CREDENTIALS_PATH = env(
...
INSTALLED_APPS = [
    ...
    "stt.publish.stt_newsml_g2_print",
    "stt.publish.stt_newsml_g2_print_timezone",
    "stt.publish.stt_newsml_g2_print_tabs",
